...
public interface IHTMLConstants {
	...
	static String[] custom_tag_array = { CUSTOM_START_TITLE_TAG,
			CUSTOM_END_TITLE_TAG, CUSTOM_START_PARA_TAG, CUSTOM_END_PARA_TAG,
			CUSTOM_START_IMAGE_TAG, CUSTOM_END_IMAGE_TAG, CUSTOM_BREAKLINE_TAG,
			CUSTOM_START_BOLD_TAG, CUSTOM_END_BOLD_TAG };
}
